...
The system uses **Content-Aware Mapping** to distinguish columns. It checks the *data* in the first row to confirm the mapping.
...
| `status` | String | 50 | No | `draft`, `in_cart`, `need_to_list`, `listed`, `sold` |
